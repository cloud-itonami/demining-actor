...
(defn collection
  [name]
  (str "com.etzhayyim.demining." name))

(def cell-specs {
  :survey-to-social {:legacy-cell "survey-to-social"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "survey-to-social")]
     :required-gates common-gates
     :trigger "manifest cell survey-to-social"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :land-release-to-public {:legacy-cell "land-release-to-public"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "land-release-to-public")]
     :required-gates common-gates
     :trigger "manifest cell land-release-to-public"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :eore-session {:legacy-cell "eore-session"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "eore-session")]
     :required-gates common-gates
     :trigger "manifest cell eore-session"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
